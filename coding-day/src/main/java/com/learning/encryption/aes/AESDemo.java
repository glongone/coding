package com.learning.encryption.aes;
...
public class AESDemo {
    ...
    public static SecretKey generateKey() throws NoSuchAlgorithmException{
        ...
        // 创建随机密码实例，SecureRandom获取加密后的一个随机数
    ...
    // 对当前内容进行加密，加密内容 content 加密方式 secretKey, Cipher为加密解密提供密码功能
    public static byte[] encrypt(String content, SecretKey secretKey){
        // Cipher.ENCRYPT_MODE 初始化解密模式
        return aes(content.getBytes(charset),Cipher.ENCRYPT_MODE,secretKey);
    }

    // 解密解密内容 contentArray 解密方式 secretKey , Cipher为加密解密提供密码功能
